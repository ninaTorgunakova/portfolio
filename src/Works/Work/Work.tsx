  ...
  return (
    <div className='card'>
      ...
      <div className='text-info'>
        ...
        <a href={props.info.linkWeb} style={props.theme.text} target='_blank' rel='noreferrer'>Link to site</a>
        <a href={props.info.linkCode} style={props.theme.text} target='_blank' rel='noreferrer'>Link to repo</a>
      </div>
    </div>
  );
};
